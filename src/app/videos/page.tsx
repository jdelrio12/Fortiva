...
// To add a video later: drop a new line into the matching library's videos list below,
// using the YouTube video id (the part after v= in the link) and a title.
const LIBRARIES: Lib[] = [
  {
...
export default function VideosPage() {
  ...
  if (lib) {
    return (
      <div>
        <button onClick={() => setLibId(null)} style={{ ...S, fontSize: 12, color: 'rgba(199,205,214,0.5)', background: 'none', border: 'none', cursor: 'pointer', padding: 0, marginBottom: 12 }}>‹ Training Videos</button>
        <div className="mb-5">
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 style={{ ...M, fontWeight: 900, fontSize: 30, letterSpacing: '0.04em', color: '#F8FAFC', lineHeight: 1 }}>TRAINING VIDEOS</h1>
        <p style={{ color: '#C7CDD6', fontSize: 13, marginTop: 6 }}>Two libraries. Sharpen your skills and your mindset.</p>
      </div>
